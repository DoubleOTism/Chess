...
public class King extends AbstractPiece implements Moveable {

    private final Moveable rook;
    private final Moveable bishop;

    public King(PieceColor pieceColor, Moveable bishop, Moveable rook) {
        super(pieceColor);
        this.name = "King";
        this.bishop = bishop;
        this.rook = rook;
